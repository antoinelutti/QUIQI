function [xVi, mask,F,Eh,Ch,Cm] = spm_est_non_sphericity(SPM)
...
if isstruct(xX.K)
    ...
    % AL - start
%     [V,h] = spm_reml(Cy,xX.X,xVi.Vi);&Original
%     [V,h,~,F] = spm_reml(Cy,xX.X,xVi.Vi);
%     Eh=0;Ch=0;
    [V,h,~,F,~,~,Eh,Ch] = spm_reml_sc(Cy,xX.X,xVi.Vi);
    % AL - end
end
